...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT NEW com.course_manage.cms.dto.UserCourseDTO(u.id, u.email) FROM User u JOIN u.courses c WHERE c.courseId = :courseId")
    List<UserCourseDTO> getUsersByCourseId(String courseId);
}